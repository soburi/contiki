PROP_SYS_ARCH_S = startup_stm32l072xx.s
...
ifndef LDSCRIPT
LDSCRIPT = $(CONTIKI)/platform/$(TARGET)/stm32cube-lib/stm32cube-prj/linker/gcc/STM32L072CZYx_FLASH.ld
endif

#ASFLAGS += -mcpu=cortex-m3 -mthumb

# this platform wields a STM32L152VB medium-density device
CFLAGS+=-DSTM32L0XX_MD=1
...
LDFLAGS += -mcpu=cortex-m0plus -mthumb  -mfloat-abi=soft -T$(LDSCRIPT) -Wl,-Map=output.map -Wl,--gc-sections -lm 
